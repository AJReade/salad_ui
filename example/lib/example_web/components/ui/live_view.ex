defmodule ExampleWeb.Components.UI.LiveView do
  @moduledoc """
...
defmodule ExampleWeb.Components.UI.JS do
  @moduledoc """
  ...
  ```elixir
  <button
    phx-click={%JS{} |> ExampleWeb.Components.UI.JS.dispatch_command("open", to: "#dialog")}> Click me </button>
  ```
  """
